...
final class ViewController: UIViewController {
    ...
    private let button5 = CustomButton(text: "Сменить тему")
    ...
    override func viewDidLoad() {
        ...
        button5.addTarget(self, action: #selector(goToThemeViewController), for: .touchUpInside)
    ...
    private func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            button5.widthAnchor.constraint(equalToConstant: view.frame.size.width),
